...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/teams/{teamID}/monitors": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Monitor create request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/monitor.createMonitorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/teams/{teamID}/monitors/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid team ID or monitor ID",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/monitor.updateMonitorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/teams/{teamID}/monitors/{id}/analytics": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Region ID to filter",
                        "name": "region_id",
                        "in": "query"
                    }
                ],
                "responses": {
                    ...
                    "404": {
                        "description": "Monitor or team not found",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
        ...
        "/teams/{teamID}/notifications/{id}": {
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid team ID or notification ID",
                        "schema": {
                            "$ref": "#/definitions/response.ErrorResponse"
                        }
                    },
        ...
        "/teams/{teamID}/notifications/{id}/test": {
            "post": {
        ...
        "/teams/{teamID}/status-pages": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Status page create request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/statuspage.statusPageUpsertRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/teams/{teamID}/status-pages/{id}": {
            "put": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Status page update request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        ...
        "statuspage.statusPageMonitorInput": {
            "type": "object",
            "required": [
                "monitor_id",
                "name",
        ...
        "statuspage.statusPageUpsertRequest": {
            ...
            "properties": {
                "groups": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/statuspage.statusPageGroupInput"
                    }
                },
                "icon": {
                    "type": "array",
