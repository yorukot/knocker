...
<div class="flex items-center gap-2">
	<Button
		...
		onclick={toggleMode}
	>
		<Sun class="size-5 rotate-0 scale-100 transition-transform duration-300 dark:-rotate-90 dark:scale-0" />
		<Moon class="size-5 absolute rotate-90 scale-0 transition-transform duration-300 dark:rotate-0 dark:scale-100" />
