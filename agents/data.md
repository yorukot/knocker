...
- `failure_threshold` and `recovery_threshold` drive incident detection/resolution (see `agents/monitoring.md`). Store them as smallints but treat as ints in code.
